...
![Robot Body Shape](images/robot_body.png)
...
![Mission Time Statistics](graphs/mission_times.png)
![Line Tracking Error](graphs/tracking_error.png)
...
- **Shared Repository:** [https://github.com/wojackbro/Optimised_Robot](https://github.com/wojackbro/Optimised_Robot)
- **MS Teams Delivery:** Upload code, `docker-compose`, videos, graphs, and the PDF design document to the private MS Teams group channel.
- **Instruction file:** `README.md` in the project root (install and test only).

---

*Documentation for ISRLAB A.Y. 2025/26 — Optimised Robot Project.*
