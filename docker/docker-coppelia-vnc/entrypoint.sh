...
mv CoppeliaSim_Edu_V4_10_0_rev0_Ubuntu24_04 $HOME/. &> /dev/null
mv /coppelia-logo.png $HOME/CoppeliaSim_Edu_V4_10_0_rev0_Ubuntu24_04/. &> /dev/null
...
# touch /etc/update-manager/release-upgrades
...
Icon=vscodium
EOF
cat << EOF > "$HOME/Desktop/coppelia-sim.desktop"
[Desktop Entry]
Name=CoppeliaSim
Comment=Robotic Simulation software from Coppelia Robotics. Formally known as VReP
Exec=$HOME/CoppeliaSim_Edu_V4_10_0_rev0_Ubuntu24_04/coppeliaSim.sh
Icon=$HOME/CoppeliaSim_Edu_V4_10_0_rev0_Ubuntu24_04/coppelia-logo.png
Terminal=true
Type=Application
...
chmod 777 $HOME/Desktop/*.desktop
